# PIV Plan: seo-plugin-skill

Project: `product-factory-os`
Created: 2026-06-01T19:50:22+00:00
Implementation report: `reports/seo-plugin-skill-implementation-report.md`
...
- What: record implementation evidence in `reports/seo-plugin-skill-implementation-report.md`.
...
- [ ] `pfo verify-work /home/hihol/projects/product-factory-os --evidence "<commands passed>" --pass-gate` writes `reports/seo-plugin-skill-implementation-report.md`.
