...
| seo-growth | Search-intent, technical SEO, content, and organic acquisition shaping before broad growth work | Feedforward | Inferential | `skills/seo/SKILL.md`, `docs/templates/CONTENT_BACKLOG.md`, `docs/templates/GO_TO_MARKET.md`, `docs/templates/VALIDATION_PLAN.md` |
