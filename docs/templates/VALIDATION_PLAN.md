...
|---|---|---|---|
| Real user conversations | Count and segment fit are explicit |  |  |
| Past behavior evidence | Users describe what they did, bought, used, hacked together, or abandoned |  |  |
| Contradicting evidence | Evidence against the hypothesis is recorded |  |  |
| BUILD truth conditions | Conditions that must be true before broad build scope are explicit |  |  |
