...
| `/seo` | URL, page, product, target queries, market, or SEO problem | `SEO_AUDIT.md`, `CONTENT_BACKLOG.md`, `GO_TO_MARKET.md`, `VALIDATION_PLAN.md`, optional `.pfo/EXPERIMENT_PROGRAM.md` | External public research, writes docs when approved | Append dated evidence; do not fabricate ranking or traffic data |
