...
def validate_wiring() -> None:
    required_snippets = {
        ...
        "scripts/validate_runtime.py": ['"validate_defensive_layers.py"'],
        "scripts/production_readiness.py": ['"scripts/validate_defensive_layers.py"'],
        "scripts/release_check.py": ['"scripts/validate_defensive_layers.py"'],
        ".github/workflows/validate.yml": [COMMAND],
        "docs/INSTALL.md": [COMMAND],
