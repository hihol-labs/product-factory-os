...
REQUIRED_FILES = [
    ...
    "tests/eval-datasets/migrate.json",
    "tests/eval-datasets/infra.json",
    "tests/eval-datasets/github-workflow.json",
    "tests/eval-datasets/tool-sync.json",
    "tests/eval-datasets/security-audit.json",
    "tests/eval-datasets/skill-create.json",
    "tests/eval-datasets/session-save.json",
    "tests/eval-datasets/seo.json",
    ...
    "scripts/validate_route_profiles.py",
...
REQUIRED_FIXTURES = [
    ...
    "adversarial-tool-misuse",
    "adversarial-fake-data",
]
