...
| Context | `preflight-context.py` | Auto-enforces full PFO runtime for first-level workspace projects when needed, then prints discovered PFO docs, state, memory, event log, and `.pfo/` contracts. | No |
